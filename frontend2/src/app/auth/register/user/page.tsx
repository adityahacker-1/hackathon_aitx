    ...
    <div className="flex min-h-screen items-center justify-center bg-orange-50 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardTitle className="text-2xl font-bold text-center text-orange-600">User Registration</CardTitle>
          <CardDescription className="text-center">
            Create your account to connect with pandits and book rituals
          </CardDescription>
        </CardHeader>
        <CardContent>
